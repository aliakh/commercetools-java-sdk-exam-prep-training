...
//    API_POC_CLIENT_PREFIX("mh-exam-prep-poc-admin."),           // Your POC admin+import client
    API_SRC_CLIENT_PREFIX("import-src-project-read."),
    LEARNING_COMPOSABLE_COMMERCE_DEVELOPER_ESSENTIALS("learning-composable-commerce-developer-essentials.");  // Source project API client
